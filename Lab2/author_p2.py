...
def main():
    ...
    rowling.publish('Harry Potter and the Philosopher\'s Stone')  # This should show error
    tolkien.publish('The Hobbit')  # This should also show error

    # Test adding new books after duplicates
    rowling.publish('Harry Potter and the Chamber of Secrets')  # This should work
    print(rowling)
